...
filtered_ch1t_nodoublets_updated <- subset(x = ch1t_nodoublets_updated, 
                         subset= (nUMI >= 500) & 
                           (nGene > 250) & (nGene<2500) &
                           (log10GenesPerUMI > 0.80) & 
                           (percent.mt < 20))

filtered_ch1n_nodoublets_updated <- subset(x = ch1n_nodoublets_updated, 
                         subset= (nUMI >= 500) & 
                           (nGene > 250) & (nGene<2500) &
                           (log10GenesPerUMI > 0.80) & 
                           (percent.mt < 20))
...
SC.list<-list(ch1t_nodoublets_updated=filtered_ch1t_nodoublets_updated,ch1n_nodoublets_updated=filtered_ch1n_nodoublets_updated)
